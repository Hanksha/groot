...
class MainController {
    ...
    ResponseEntity regulaFalsi(@RequestParam String func, @RequestParam double x0, @RequestParam double x1) {

    }

    @RequestMapping(value = '/secant', method = RequestMethod.GET)
    ResponseEntity secant(@RequestParam String func, @RequestParam double x0, @RequestParam double x1) {
